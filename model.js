...
class Link {
    ...
    draw_trafficstate() {
        ...
        var k_ref = 1
        var v_ref = 3
        draw_text("flujo", this.px - 30, this.py + py0, "#000000", 12)
        draw_text("densidad", this.px - 30, this.py + py0 + pdy, "#000000", 12)
        draw_text("velocidad", this.px - 30, this.py + py0 + pdy * 2, "#000000", 12)
...
class Spawner {
    ...
    draw() {
        draw_text("influjo = " + this.flow.toFixed(2), this.link.px, this.link.py - 20, "#000000", 12)
    }
